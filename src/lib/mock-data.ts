...
export const mockTemplates: ContractTemplate[] = [
  {
    id: "tmpl_1",
    name: "Standard Residential Contract",
    category: "Residential",
    body: "RESIDENTIAL CONSTRUCTION CONTRACT\n\nThis agreement is entered into between QTC Construction LLC (\"Contractor\") and {{customer}} (\"Client\") for the completion of a {{project_type}} project.\n\nScope of Work:\n{{scope}}\n\nTotal Contract Amount: ${{amount}}\nPayment Schedule: As outlined in attached milestone schedule.\n\nTimeline: {{timeline}} from start date.\n\nWarranty: 1-year workmanship warranty included.",
  ...
  },
  {
    ...
    category: "Commercial",
    body: "COMMERCIAL CONSTRUCTION AGREEMENT\n\nBetween QTC Construction LLC and {{customer}} for commercial build-out at {{address}}.\n\nProject: {{project_type}}\nContract Value: ${{amount}}\n\nInsurance & Bonding: Contractor shall maintain general liability insurance of no less than $2,000,000.\n\nChange Orders: All changes must be approved in writing.",
  ...
  },
  {
    ...
    category: "Renovation",
    body: "RENOVATION CONTRACT\n\nThis agreement covers the renovation project for {{customer}}.\n\nProject Type: {{project_type}}\nLocation: {{address}}\nTotal: ${{amount}}\n\nIncludes: Demolition, plumbing rough-in, electrical, tile, fixtures, finish carpentry.\n\nTimeline: {{timeline}}",
  ...
  },
  {
    ...
    category: "Roofing",
    body: "ROOFING CONTRACT\n\nContractor: QTC Construction LLC\nClient: {{customer}}\n\nWork: Complete tear-off and re-roof of {{project_type}} at {{address}}.\nMaterials: As specified in attached material schedule.\nTotal: ${{amount}}\n\nWarranty: Manufacturer warranty + 5-year labor warranty.",
  ...
  },
  {
    ...
    body: "SUBCONTRACTOR AGREEMENT\n\nBetween QTC Construction LLC (\"General Contractor\") and {{customer}} (\"Subcontractor\").\n\nProject: {{project_type}}\nScope: {{scope}}\nCompensation: ${{amount}}\n\nSubcontractor shall provide own tools, equipment, and insurance.\nPayment: Net 30 from invoice approval.",
